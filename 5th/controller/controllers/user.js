...
const user = {
    signup : async (req, res) => { //callback 만 따로 
        const {
            id,
            name,
            password,
            email
        } = req.body;  //request 하는 body 부분
...
//본래 user.js 긴 부분에서 콜백함수만 따로 가져오고 routes는 routing 기능만 할 수 있도록
//@@controller는 routes 에서 콜백함수를 옮겨 온 것이다!